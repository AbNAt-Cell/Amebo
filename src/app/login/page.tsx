            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="bg-white dark:bg-[#181b21] rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 p-8">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center gap-2">
                                <input
                                    type="checkbox"
                                    className="w-4 h-4 rounded border-gray-300 text-[#8D1CDF] focus:ring-[#8D1CDF]"
                                />
                            ...
                            <Link
                                ...
                                className="text-sm text-[#8D1CDF] hover:underline"
                            >
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <Link href="/signup" className="text-[#8D1CDF] font-medium hover:underline">
                            Sign up for free
                        </Link>
                    </p>
                </div>
